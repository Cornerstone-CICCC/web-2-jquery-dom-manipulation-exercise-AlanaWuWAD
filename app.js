...
$(function() {
    ...
    $("#exercise1Button").on('click', function() {
      $("#exercise1 ul").find("li").css('color','red')
    });
    ...
    $("#exercise3Button").on('click', function() {
      $("#exercise3 p").parents('div').css('background-color','lightblue')
    });
    ...
    $("#exercise6Button").on('click', function() {
      $(this).siblings('div').find('span').css('color','green')
    });
})